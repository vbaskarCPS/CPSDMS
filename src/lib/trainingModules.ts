        ...
        frames: [
          {
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/cps-van.png`, x: 48, y: 86 },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 42, y: 84 },
            ],
          },
          {
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 42, y: 84 },
              { type: 'icon', src: `${STORAGE_BASE}/red-running-figure.png`, x: 38, y: 80 },
              { type: 'label', text: 'Run Forest, Run...', x: 52, y: 68, color: '#ef4444' },
            ],
          },
          {
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 42, y: 84 },
              { type: 'icon', src: `${STORAGE_BASE}/red-running-figure.png`, x: 38, y: 80 },
              { type: 'label', text: '10', x: 50, y: 44, color: '#f59e0b' },
            ],
          },
          {
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 40, y: 42 },
              { type: 'icon', src: `${STORAGE_BASE}/red-running-figure.png`, x: 38, y: 40 },
              { type: 'label', text: 'Cut across lawn', x: 55, y: 38, color: '#ef4444' },
            ],
          },
          {
            label: 'First Sale!',
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 40, y: 42 },
              { type: 'icon', src: `${STORAGE_BASE}/red-running-figure.png`, x: 47, y: 35 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 28, y: 24 },
              { type: 'label', text: '1st sale', x: 22, y: 27, color: '#ef4444' },
            ],
          },
          {
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 40, y: 42 },
              { type: 'icon', src: `${STORAGE_BASE}/red-running-figure.png`, x: 52, y: 26 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 28, y: 24 },
              { type: 'label', text: '1st sale', x: 22, y: 27, color: '#ef4444' },
            ],
          },
          {
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 40, y: 42 },
              { type: 'icon', src: `${STORAGE_BASE}/red-running-figure.png`, x: 40, y: 45 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 28, y: 24 },
              { type: 'label', text: '1st sale', x: 22, y: 27, color: '#ef4444' },
              { type: 'label', text: 'Fancy a cold one?', x: 68, y: 12, color: '#ef4444' },
            ],
          },
          {
            ...
            overlays: [
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 28, y: 24 },
              { type: 'label', text: '1st sale', x: 22, y: 27, color: '#ef4444' },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 50, y: 28 },
              { type: 'label', text: '15-20 min', x: 58, y: 22, color: '#3b82f6' },
            ],
          },
          {
            ...
            overlays: [
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 28, y: 24 },
              { type: 'label', text: '1st sale', x: 22, y: 27, color: '#ef4444' },
              { type: 'label', text: 'Go Back', x: 22, y: 33, color: '#ef4444' },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 50, y: 28 },
              { type: 'label', text: 'Keep going!', x: 58, y: 22, color: '#22c55e' },
            ],
          },
        ],
      },
        ...
        frames: [
          {
            ...
            overlays: [
              { type: 'icon', src: `${STORAGE_BASE}/cps-van.png`, x: 72, y: 80 },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 68, y: 72 },
            ],
          },
          {
            ...
            overlays: [
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 78, y: 26 },
              { type: 'label', text: '1st sale (John)', x: 84, y: 26, color: '#dc2626' },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 60, y: 10 },
              { type: 'label', text: '1st mushroom (Mary)', x: 68, y: 10, color: '#dc2626' },
              { type: 'label', text: 'On the fence', x: 82, y: 20, color: '#f59e0b' },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 68, y: 72 },
            ],
          },
          {
            ...
            overlays: [
              ...
              { type: 'label', text: '1st mushroom (Mary)', x: 68, y: 10, color: '#dc2626' },
              { type: 'label', text: 'On the fence', x: 82, y: 20, color: '#f59e0b' },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 38, y: 30 },
              { type: 'label', text: '2nd mushroom (Mark)', x: 24, y: 30, color: '#dc2626' },
              { type: 'label', text: 'Not today', x: 34, y: 26, color: '#f59e0b' },
              { type: 'label', text: 'Nobody home', x: 40, y: 42, color: '#6b7280' },
              { type: 'label', text: 'Nobody home', x: 40, y: 50, color: '#6b7280' },
              { type: 'label', text: 'On the fence', x: 84, y: 32, color: '#f59e0b' },
              { type: 'label', text: 'Too expensive', x: 88, y: 40, color: '#f59e0b' },
          ...
          },
          {
            ...
            caption:
              'After completing the mushroom, you return to finish John\'s lawn. On the way back you notice a car pulling into a driveway. STOP. Run over. Using John, Mary, and Mark\'s names, you approach Joe. He says yes. Eyes & Ears trumps everything!',
            overlays: [
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 78, y: 26 },
              { type: 'label', text: '1st sale (John)', x: 84, y: 26, color: '#dc2626' },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 60, y: 10 },
              ...
              { type: 'label', text: 'On the fence', x: 84, y: 32, color: '#f59e0b' },
              { type: 'label', text: 'Too expensive', x: 88, y: 40, color: '#f59e0b' },
              { type: 'icon', src: `${STORAGE_BASE}/car-overhead.png`, x: 78, y: 82 },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 70, y: 24 },
            ],
          },
          {
            label: 'Joe Closes + Complete Aerations',
            caption:
            ...
            overlays: [
              ...
              { type: 'label', text: 'On the fence', x: 84, y: 32, color: '#f59e0b' },
              { type: 'label', text: 'Too expensive', x: 88, y: 40, color: '#f59e0b' },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 85, y: 48 },
              { type: 'label', text: '1st Eyes & Ears (Joe)', x: 90, y: 48, color: '#dc2626' },
              { type: 'icon', src: `${STORAGE_BASE}/car-overhead.png`, x: 78, y: 52 },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 60, y: 30 },
            ],
          },
          {
            ...
            overlays: [
              ...
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 38, y: 30 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 85, y: 48 },
              { type: 'label', text: '2nd Eyes & Ears (Julie)', x: 30, y: 4, color: '#dc2626' },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 20, y: 8 },
              { type: 'icon', src: `${STORAGE_BASE}/lady-walking-dog.png`, x: 52, y: 85 },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 42, y: 32 },
              { type: 'label', text: 'On the fence', x: 84, y: 32, color: '#f59e0b' },
              { type: 'label', text: 'Too expensive', x: 88, y: 40, color: '#f59e0b' },
              { type: 'icon', src: `${STORAGE_BASE}/car-overhead.png`, x: 78, y: 52 },
            ],
          },
          {
            ...
            overlays: [
              ...
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 85, y: 48 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 20, y: 8 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 90, y: 60 },
              { type: 'label', text: 'Mushroom (Joanne)', x: 90, y: 56, color: '#dc2626' },
              { type: 'label', text: 'Not interested', x: 42, y: 70, color: '#f59e0b' },
              { type: 'label', text: 'Too dry', x: 42, y: 78, color: '#f59e0b' },
              { type: 'label', text: 'Have contractor', x: 58, y: 88, color: '#f59e0b' },
              { type: 'label', text: 'Nobody home', x: 48, y: 90, color: '#6b7280' },
              { type: 'label', text: 'No Habla Ingles', x: 92, y: 78, color: '#f59e0b' },
              { type: 'label', text: 'Too wet', x: 92, y: 86, color: '#f59e0b' },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 60, y: 35 },
            ],
          },
          {
            ...
            overlays: [
              ...
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 20, y: 8 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 90, y: 60 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 82, y: 30 },
              { type: 'label', text: 'Go back (Bill)', x: 82, y: 28, color: '#dc2626' },
              { type: 'label', text: 'Too expensive', x: 88, y: 40, color: '#f59e0b' },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 62, y: 52 },
            ],
          },
          {
            label: 'Go-Back Sale: Rita',
            caption:
              'Rita was "too expensive" earlier. With 7 names and flags everywhere, the social proof is overwhelming. She agrees to the original price. Go-Back closed. That\'s 8 sales from 1 cold start.',
            overlays: [
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 78, y: 26 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 60, y: 10 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 38, y: 30 },
              ...
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 90, y: 60 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 82, y: 30 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 88, y: 38 },
              { type: 'label', text: 'Go back (Rita)', x: 88, y: 36, color: '#dc2626' },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 62, y: 52 },
            ],
          },
          {
            ...
            overlays: [
              ...
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 82, y: 30 },
              { type: 'flag', src: `${STORAGE_BASE}/flag.png`, x: 88, y: 38 },
              { type: 'icon', src: `${STORAGE_BASE}/aerator-icon.png`, x: 22, y: 10 },
              { type: 'label', text: 'Start over from here!', x: 22, y: 4, color: '#22c55e' },
            ],
          },
        ],
      },
